...
namespace ilp_solver
{
    class ILPSolverInterface
    {
        public:
            ...
            virtual void add_variable_integer    (                                                                                double p_objective, int    p_lower_bound, int    p_upper_bound, const std::string& p_name = "") = 0;
            virtual void add_variable_integer    (                                       const std::vector<double>& p_row_values, double p_objective, int    p_lower_bound, int    p_upper_bound, const std::string& p_name = "") = 0;
            virtual void add_variable_integer    (const std::vector<int>& p_row_indices, const std::vector<double>& p_row_values, double p_objective, int    p_lower_bound, int    p_upper_bound, const std::string& p_name = "") = 0;
