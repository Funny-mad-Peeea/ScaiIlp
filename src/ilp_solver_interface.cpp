...
namespace ilp_solver
{
    ...
    void ILPSolverInterface::add_variable_boolean(const vector<int>& p_row_indices, const vector<double>& p_row_values, double p_objective, string p_name)
    {
        do_add_variable(p_row_indices, p_row_values, p_objective, 0, 1, p_name, VariableType::INTEGER);
    }
    
    void ILPSolverInterface::add_variable_integer(double p_objective, int p_lower_bound, int p_upper_bound, string p_name)
    {
        add_variable_integer(vector<int>(), vector<double>(), p_objective, p_lower_bound, p_upper_bound, p_name);
    }

    void ILPSolverInterface::add_variable_integer(const vector<int>& p_row_indices, const vector<double>& p_row_values, double p_objective, int p_lower_bound, int p_upper_bound, string p_name)
    {
    ...
    void ILPSolverInterface::add_variable_continuous(const vector<int>& p_row_indices, const vector<double>& p_row_values, double p_objective, double p_lower_bound, double p_upper_bound, string p_name)
    {
        do_add_variable(p_row_indices, p_row_values, p_objective, p_lower_bound, p_upper_bound, p_name, VariableType::CONTINUOUS);
    }
    
    void ILPSolverInterface::add_constraint(const vector<int>& p_col_indices, const vector<double>& p_col_values, double p_lower_bound, double p_upper_bound, string p_name)
    {
        do_add_constraint(p_col_indices, p_col_values, p_lower_bound, p_upper_bound, p_name);
    }
    
    void ILPSolverInterface::add_constraint_upper(const vector<int>& p_col_indices, const vector<double>& p_col_values, double p_upper_bound, string p_name)
    {
    ...
    void ILPSolverInterface::add_constraint_lower(const vector<int>& p_col_indices, const vector<double>& p_col_values, double p_lower_bound, string p_name)
    {
    ...
    void ILPSolverInterface::add_constraint_equality(const vector<int>& p_col_indices, const vector<double>& p_col_values, double p_value, string p_name)
    {
