...
namespace ilp_solver
{
    ...
    class ILPSolverOsiModel : public ILPSolverInterfaceImpl
    {
        ...
        private:
            ...
            virtual void                      do_solve      (const std::vector<double>& p_start_solution, double p_start_value,
                                                             int p_num_threads, bool p_deterministic, int p_log_level, double p_max_seconds) = 0; // not always implemented as solver().branchAndBound() (see ILPSolverCbc)
            ...
            void do_prepare_and_solve   (const std::vector<double>& p_start_solution, double p_start_value,
